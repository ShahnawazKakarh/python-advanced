...
num_list = ['zero', 'one', 'two', 'three', 'four', 'five', 'six',
            'seven', 'eight', 'nine']  # Example of a list containing strings

# You can access elements in a list using negative indexing, which counts
...
# Slicing to get the second element and replace it with "Lemon"
slicing_second_num = num_list[1:2] = "Lemon"
# Output: ['zero', 'Lemon', 'two', 'three', 'four', 'five', 'six', 'seven', 'eight', 'nine']
print(slicing_second_num)

num_list[1:3]  # Slicing to get the second and third elements
print(num_list[1:3])  # Output: ['Lemon', 'two']


# Replacing the second and third elements with 'Orange'
num_list[1:3] = ['Orange']
# Output: ['zero', 'Orange', 'three', 'four', 'five', 'six', 'seven', 'eight', 'nine']
print(num_list)
...
# Replacing the second element with two new elements 'test'
num_list[1:2] = ['test', 'test']
# Output: ['zero', 'test', 'test', 'three', 'four', 'five', 'six', 'seven', 'eight', 'nine']
print(num_list)
...
if 'Green Tea' in tea_list:  # Checking if 'Green Tea' is in the list
    ...
    print("\nGreen Tea is not available.") and tea_list.append(
        'Green Tea')  # Adding 'Green Tea' to the list if not present
...
# Output: ['Green Tea', 'Black Tea', 'Herbal Tea', 'Masala Tea', 'Oolong Tea']
print(tea_list)
...
# Output: ['Green Tea', 'Herbal Tea', 'Masala Tea', 'Oolong Tea']
print(tea_list)

# You can pop an element from the list using the pop() method.
...
tea_list.insert(1, 'Chai Tea')  # Inserting 'Chai Tea' at index 1
# Output: ['Green Tea', 'Chai Tea', 'Herbal Tea', 'Oolong Tea']
print(tea_list)

tea_list_copy = tea_list.copy()  # Creating a copy of the tea_list
# Output: ['Green Tea', 'Chai Tea', 'Herbal Tea', 'Oolong Tea']
print(tea_list_copy)
...
# You can create a new list by applying an expression to each item in an
# existing iterable.
# Creating a list of squared numbers from 0 to 9
...
# You can also use the extend() method to add multiple elements from
# another iterable.
my_list.extend([11, 12])  # Extending the list with new elements
print(my_list)  # Output: [10, 2, 3, 4, 5, 6, 11, 12]

# Lists support various methods for manipulation, such as sort(),
# reverse(), pop(), remove(), etc.
...
# You can also pop an element from the list, which removes it and returns
# the value.
...
even_squares = [
    x**2 for x in range(10) if x %
    2 == 0]  # Squaring only even numbers
print(even_squares)  # Output: [0, 4, 16, 36, 64]

# Lists can be sliced similarly to strings, allowing you to access a range
# of elements.
...
is_equal_list = my_list == [12, 11, 6, 5, 4, 3]
...
# Output: True (because the first element 12 is greater than 10)
...
# Lists can be used to store mixed data types, including strings, numbers,
# and other lists.
...
# You can also use the 'del' statement to remove an element from a list by
# its index.
del my_list[0]
...
# You can also use the sorted() function to return a new sorted list
...
# For example, you can use the append() method to add elements to the end
# of a list (like a stack).
stack = []
stack.append(1)  # Push 1 onto the stack
stack.append(2)  # Push 2 onto the stack
print(stack)  # Output: [1, 2]

# You can use the pop() method to remove elements from the end of the list
# (like a stack).
popped_element = stack.pop()
print(popped_element)  # Output: 2 (the last element popped from the stack)
print(stack)  # Output: [1] (after popping)

# Lists can also be used as queues by using the pop(0) method to remove
